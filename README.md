...
Bu proje, klasik Taş-Kağıt-Makas oyununu tarayıcı üzerinden oynayabileceğiniz basit bir HTML/CSS/JavaScript uygulamasıdır. Oyuncu adı girerek ve zorluk seviyesi seçerek oyuna başlayabilirsiniz.

## 🧩 Özellikler

- Oyuncu adı ve zorluk seviyesi seçimi
- 5 turluk oyun sistemi
- Bilgisayarın rastgele seçimleri
- Skor takibi ve en iyi skor gösterimi
